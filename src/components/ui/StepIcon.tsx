      ...
      >
        <defs>
          <linearGradient id="auditGrad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#4A95E0" />
            <stop offset="100%" stopColor="#2D70BA" />
          </linearGradient>
          <filter id="auditGlow">
        ...
        <g filter="url(#auditGlow)">
          ...
          <path d="M11 14V11H14" stroke="#4A95E0" strokeWidth="2" strokeLinecap="round" />
          <path d="M26 11H29V14" stroke="#4A95E0" strokeWidth="2" strokeLinecap="round" />
          <path d="M29 26V29H26" stroke="#4A95E0" strokeWidth="2" strokeLinecap="round" />
          <path d="M14 29H11V26" stroke="#4A95E0" strokeWidth="2" strokeLinecap="round" />
        </g>
      </svg>
    ),
      ...
      >
        <defs>
          <linearGradient id="buildGrad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#2D70BA" />
            <stop offset="100%" stopColor="#3E7C6A" />
          </linearGradient>
          <filter id="buildGlow">
            <feGaussianBlur stdDeviation="0.6" result="coloredBlur" />
            <feMerge>
        ...
        <g filter="url(#buildGlow)">
          ...
          <line x1="24" y1="19" x2="24" y2="14" stroke="#2D70BA" strokeWidth="2" />
          <line x1="29" y1="24" x2="34" y2="24" stroke="#2D70BA" strokeWidth="2" />
          <line x1="24" y1="29" x2="24" y2="34" stroke="#3E7C6A" strokeWidth="2" />
          <line x1="19" y1="24" x2="14" y2="24" stroke="#3E7C6A" strokeWidth="2" />
        </g>
      </svg>
    ),
      ...
      >
        <defs>
          <linearGradient id="launchGrad" x1="0%" y1="100%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#3E7C6A" />
            <stop offset="50%" stopColor="#4A95E0" />
            <stop offset="100%" stopColor="#2D70BA" />
          </linearGradient>
        ...
        <g filter="url(#launchGlow)">
          ...
          <path d="M16 28L8 36L12 28" stroke="#3E7C6A" strokeWidth="2.5" strokeLinejoin="round" fill="none" />
          <path d="M32 28L40 36L36 28" stroke="#2D70BA" strokeWidth="2.5" strokeLinejoin="round" fill="none" />
          <path d="M24 42L21 46L24 44L27 46L24 42Z" fill="#4A95E0" />
          <path d="M22 44L20 47" stroke="#4A95E0" strokeWidth="2" strokeLinecap="round" />
          <path d="M26 44L28 47" stroke="#4A95E0" strokeWidth="2" strokeLinecap="round" />
        </g>
      </svg>
    ),
    ...
    scale: (
      ...
      >
        ...
        <g filter="url(#scaleGlow)">
          ...
          <path d="M36 8L40 14L34 14" stroke="#4A95E0" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="none" />
          <circle cx="12" cy="34" r="3" fill="#4A95E0" />
          <circle cx="20" cy="26" r="3" fill="#2D70BA" />
          <circle cx="28" cy="30" r="3" fill="#3E7C6A" />
          <circle cx="40" cy="14" r="3" fill="#4A95E0" />
      ...
      >
        <defs>
          <linearGradient id="rankGrad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#FF7099" />
            <stop offset="100%" stopColor="#4A95E0" />
          </linearGradient>
          <filter id="rankGlow">
            <feGaussianBlur stdDeviation="0.6" result="coloredBlur" />
            <feMerge>
        ...
        <g filter="url(#rankGlow)">
          <rect x="6" y="28" width="10" height="16" fill="#FF7099" opacity="0.6" rx="2" />
          <rect x="19" y="20" width="10" height="24" fill="url(#rankGrad)" rx="2" />
          <rect x="32" y="12" width="10" height="32" fill="#4A95E0" rx="2" />
          <text x="11" y="38" fill="#FAF6EE" fontSize="8" fontWeight="bold" textAnchor="middle">3</text>
          <text x="24" y="32" fill="#FAF6EE" fontSize="8" fontWeight="bold" textAnchor="middle">2</text>
          <text x="37" y="24" fill="#FAF6EE" fontSize="8" fontWeight="bold" textAnchor="middle">1</text>
          <path d="M32 8L34 4L37 6L40 4L42 8H32Z" fill="#E0A93E" />
        </g>
      </svg>
    ),
      ...
      >
        ...
        <g filter="url(#moneyGlow)">
          ...
          <path
            ...
            strokeLinecap="round"
          />
          <path d="M36 16L36 32M36 32L30 26M36 32L42 26" stroke="#4A95E0" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
          <circle cx="38" cy="12" r="2" fill="#4A95E0" />
        </g>
      </svg>
    ),
    ...
    tracking: (
      ...
      >
        ...
        <g filter="url(#trackGlow)">
          ...
          <rect x="8" y="10" width="12" height="8" rx="1" fill="#2D70BA" opacity="0.6" />
          <rect x="22" y="10" width="18" height="8" rx="1" fill="#4A95E0" opacity="0.6" />
          <path d="M8 26L14 22L20 24L28 18L36 20" stroke="#4A95E0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M34 12L36 14L40 10" stroke="#4A95E0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </svg>
    ),
    ...
    time: (
      ...
      >
        ...
        <g filter="url(#timeGlow)">
          ...
          <path d="M40 24C40 32.8 32.8 40 24 40" stroke="#4A95E0" strokeWidth="2" strokeLinecap="round" strokeDasharray="4 4" />
          <path d="M8 24C8 15.2 15.2 8 24 8" stroke="#3E7C6A" strokeWidth="2" strokeLinecap="round" strokeDasharray="4 4" />
          <path d="M38 18L42 14L40 18L44 18L40 22" stroke="#4A95E0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </svg>
    )
  }
